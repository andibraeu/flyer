...
\begin{enumerate}
 ...
 \item Öffne in einem Browserfenster die Adresse \textit{http://192.168.0.1} und melde Dich mit \textit{admin} und dem Paßwort \textit{admin} an.
 ...
 \item Nun warte etwa bis das Upgrade durchgelaufen ist. Danach richtet sich der Knoten selbstständig ein. Dieser Vorgang kann bis zu einer Stunde dauern.
\end{enumerate}
